...
//uncomment above and comment out below for a sample test case 

const symbols = ["BF.B", "LRCX", "NI", "WTW", "MMM", "AOS", "ABT", "ABBV", "ABMD", "ACN", "ATVI", "ADM", "ADBE", "AAP", "AMD", "AES", "AFL", "A",
