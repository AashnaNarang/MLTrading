const symbols = ["LRCX", "NI", "WTW", "MMM", "AOS", "ABT", "ABBV", "ABMD", "ACN", "ATVI", "ADM", "ADBE", "AAP", "AMD", "AES", "AFL", "A"]


// ["BF.B", "LRCX", "NI", "WLTW", "MMM", "AOS", "ABT", "ABBV", "ABMD", "ACN", "ATVI", "ADM", "ADBE", "AAP", "AMD", "AES", "AFL", "A",
...
"BF..";
module.exports = {
    symbols,
  };
